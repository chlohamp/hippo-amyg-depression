...
write.csv(socioenv_res, paste(out_dir,
  "plsc_socioenv_loadings_bootstrap.csv",
  sep = "/"
), row.names = TRUE)

write.csv(depression_res, paste(out_dir,
  "plsc_depression_loadings_bootstrap.csv",
  sep = "/"
), row.names = TRUE)

rownames(pls.res$TExPosition.Data$lx) <- covar_df$participant_id
rownames(pls.res$TExPosition.Data$ly) <- covar_df$participant_id

write.csv(pls.res$TExPosition.Data$lx, paste(out_dir,
  "plsc_LV_scores_socioenv.csv",
  sep = "/"
), row.names = TRUE)

write.csv(pls.res$TExPosition.Data$ly, paste(out_dir,
  "plsc_LV_scores_depression.csv",
  sep = "/"
), row.names = TRUE)
